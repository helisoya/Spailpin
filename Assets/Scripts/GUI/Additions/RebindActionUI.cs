...
////TODO: deal with composites that have parts bound in different control schemes
    ...
    public class RebindActionUI : MonoBehaviour
    {
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if (allCompositeParts)
                        {
                            ...
                            else Settings.instance.SetBindings(GameManager.instance.GetInputs().SaveBindingOverridesAsJson());
                        }else{
        ...
        [SerializeField]
        private LocalizedText m_ActionLabel;
        ...
        private void UpdateActionLabel()
        {
            ...
            {
                var action = m_Action?.action;
                m_ActionLabel.SetNewKey("options_controls_rebind_"+(action != null ? action.name : "Error"));
            }
        }
